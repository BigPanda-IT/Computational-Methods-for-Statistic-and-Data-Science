...
for (r in rs) {
  ...
  windows(width = 12, height = 8) 
  par(mfrow = c(5, 10), mar = c(2, 2, 2, 2) + 0.1) 
...
result2 <- nnmf(X, r, V = V2, W = W2, maxiter = 1000) 
